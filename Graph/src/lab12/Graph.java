 ...
 * an instance of the Graph class). The Graph class also has a flag
 * to indicate whether it is bipartite.
 * 
 ...
 * including spanning tree, connected components, bipartite flag.
