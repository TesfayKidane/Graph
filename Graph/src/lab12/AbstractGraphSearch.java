...
public abstract class AbstractGraphSearch {
	...
	public void start() {
		while(someVertexUnvisited()) {	
			...
			//by choosing (in an as yet unspecified way) next vertex that is adjacent
			...
			//          add w to VISITED
			//THEOREM: After completion of the loop,
			//v is in VISITED if and only if there is a path in G
			//from s to v
			singleComponentLoop();	
