...
public class Digraph {
	...
	public boolean reaches(Vertex u, Vertex v) {
		...
		dfs.start(u);
		return dfs.getVisitedVerticesAsList().contains(v);
	}
	...
	public List<Vertex> reachable(Vertex u) {
		DepthFirstSearch dfs = new DepthFirstSearch(this);
		dfs.start(u);
		return dfs.getVisitedVerticesAsList();// new ArrayList<Vertex>();
	}
	...
	public boolean isStronglyConnected() {
		Vertex u = vertices.getLast();
		DepthFirstSearch dfs = new DepthFirstSearch(this);
		dfs.start(u);
		List<Vertex> reachableVertices = dfs.getVisitedVerticesAsList();
		if(reachableVertices.size() != vertices.size())
			return false;
